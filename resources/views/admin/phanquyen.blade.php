        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route(name: 'admin') }}" class="nav-item nav-link "><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <a href="{{route('removeAdmin', $user->id)}}">
                                                <button type="button" class="btn btn-square btn-outline-primary m-2" title="Hủy quyền quản trị"><i class="bi bi-person-fill-dash"></i></i></button>
                                            </a>
