    ...
    <body>
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="{{ route(name: 'paymentsAdmin') }}" class="nav-item nav-link active"><i class="bi bi-credit-card-2-back"></i>Payments</a>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4" style="height: 80%;">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4">TRANSACTIONS LIST</h4>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $transaction->number_of_people }}</td>
                ...
                <!-- Nếu có phân trang thì thêm đoạn này -->
            </div>
        </div>
